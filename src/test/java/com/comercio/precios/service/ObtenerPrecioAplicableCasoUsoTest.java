...
class ObtenerPrecioAplicableCasoUsoTest {
    ...
    void ejecutar_cuandoHayPrecio_devuelveDominio() {
        ...
        var resultado = casoUso.ejecutar(35455L, 1L, fecha);
